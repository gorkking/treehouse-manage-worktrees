...
## [3.0.0](https://github.com/gorkking/treehouse-manage-worktrees/compare/v2.3.0...v3.0.0) (2026-08-25)
...
* add --root flag and TREEHOUSE_ROOT env for the worktree root ([#93](https://github.com/gorkking/treehouse-manage-worktrees/issues/93)) ([5e3d282](https://github.com/gorkking/treehouse-manage-worktrees/commit/5e3d282592dfef5e60a5027797aa917f08c6cbf0))
* add Nix package manager install support ([#113](https://github.com/gorkking/treehouse-manage-worktrees/issues/113)) ([4307a30](https://github.com/gorkking/treehouse-manage-worktrees/commit/4307a30f6d18457200dbd15954a56d75749454b8))
* add no-fetch worktree acquisition ([164d903](https://github.com/gorkking/treehouse-manage-worktrees/commit/164d9036569a406d664f988f064c6a58eea1a645))
* **cmd:** add global prune mode ([#26](https://github.com/gorkking/treehouse-manage-worktrees/issues/26)) ([6de3a91](https://github.com/gorkking/treehouse-manage-worktrees/commit/6de3a9150453cc5cf5fb4e95627788551adae66c))
* **cmd:** make destroy safe by default ([#37](https://github.com/gorkking/treehouse-manage-worktrees/issues/37)) ([0190382](https://github.com/gorkking/treehouse-manage-worktrees/commit/0190382c6f3b95025667b5b01e688e779bf3c516))
* **config:** add configurable root for pool directory ([#12](https://github.com/gorkking/treehouse-manage-worktrees/issues/12)) ([0bc1378](https://github.com/gorkking/treehouse-manage-worktrees/commit/0bc1378b758ac93bb4ca430a942e87a5c3b8f020))
* initial project setup ([bfc295d](https://github.com/gorkking/treehouse-manage-worktrees/commit/bfc295dd52e0452b5a69ea2642864449380d54b5))
* **nix:** add flake.nix and flake.lock ([#15](https://github.com/gorkking/treehouse-manage-worktrees/issues/15)) ([500d2f9](https://github.com/gorkking/treehouse-manage-worktrees/commit/500d2f9e26429d02e8378142556af8ad9be8cbd0))
* **pool:** add durable worktree leases ([#35](https://github.com/gorkking/treehouse-manage-worktrees/issues/35)) ([97d6708](https://github.com/gorkking/treehouse-manage-worktrees/commit/97d67089ea55cba166c3f4d5332e9a7a09206057))
* **pool:** add stable lease identities ([#68](https://github.com/gorkking/treehouse-manage-worktrees/issues/68)) ([e914cca](https://github.com/gorkking/treehouse-manage-worktrees/commit/e914cca93693be4c47e0a4df1bf7439afd5e820a))
* **pool:** add user lifecycle hooks ([#22](https://github.com/gorkking/treehouse-manage-worktrees/issues/22)) ([9c70d0b](https://github.com/gorkking/treehouse-manage-worktrees/commit/9c70d0b73c6ca1c1783828f3e9d215612993a3b4))
* **pool:** classify orphaned worktrees during prune ([#28](https://github.com/gorkking/treehouse-manage-worktrees/issues/28)) ([836044f](https://github.com/gorkking/treehouse-manage-worktrees/commit/836044f85e992d2fd65969dca387704998c144b6))
* **prune:** add safe stale worktree pruning ([#24](https://github.com/gorkking/treehouse-manage-worktrees/issues/24)) ([3395c20](https://github.com/gorkking/treehouse-manage-worktrees/commit/3395c20e41dbb563e3437c4a0a5e031ce042ca2a))
* **status:** show current worktree status ([75b24a0](https://github.com/gorkking/treehouse-manage-worktrees/commit/75b24a0b8a0fe2ea4ed88e8a28288c529403e951))
* use latest default branch for worktree ([df3ee7b](https://github.com/gorkking/treehouse-manage-worktrees/commit/df3ee7b364aab64e1d7099422815ebeb43dc6c58))
* **vcs:** add opt-in Jujutsu (jj) workspace backend behind a VCS seam ([#100](https://github.com/gorkking/treehouse-manage-worktrees/issues/100)) ([a2e554c](https://github.com/gorkking/treehouse-manage-worktrees/commit/a2e554c15e0c8de0e8cbc0e45549acc59f6b97f9))
* **vcs:** slot-flavor dispatch, flavor-aware acquire, and markerless fail-closed hardening ([#110](https://github.com/gorkking/treehouse-manage-worktrees/issues/110)) ([c88b53e](https://github.com/gorkking/treehouse-manage-worktrees/commit/c88b53ef6149054435fd375806117dfcd8371a0d))


### Bug Fixes

* app update permission error ([0559e99](https://github.com/gorkking/treehouse-manage-worktrees/commit/0559e99680c8d1f0a99f969c9fdf5407e4027aa3))
* CI failures ([d744564](https://github.com/gorkking/treehouse-manage-worktrees/commit/d744564529cad1975c78a29b2b8ed4d61d529977))
* **ci:** make update-vendor-hash fork-aware for checkout and push ([#105](https://github.com/gorkking/treehouse-manage-worktrees/issues/105)) ([6c40205](https://github.com/gorkking/treehouse-manage-worktrees/commit/6c40205c69855998ed2fac19d3c75751b504243a))
* **ci:** suppress pull_request runs on release-please PRs ([#77](https://github.com/gorkking/treehouse-manage-worktrees/issues/77)) ([da7eda2](https://github.com/gorkking/treehouse-manage-worktrees/commit/da7eda26e5f26e0a1bf87a0d67e7553d72952cdf))
* **cli:** expose version flag and set rootCmd.Version ([ac84c4a](https://github.com/gorkking/treehouse-manage-worktrees/commit/ac84c4a38c72b75a9fe633e138b50aaf66d20e26))
* **cmd:** detach worktrees before pool reuse ([#19](https://github.com/gorkking/treehouse-manage-worktrees/issues/19)) ([0d849a3](https://github.com/gorkking/treehouse-manage-worktrees/commit/0d849a3b82a8647f507b1e2f186dc041c930fe35))
* **cmd:** resolve main repo root for pool commands run inside a worktree ([#51](https://github.com/gorkking/treehouse-manage-worktrees/issues/51)) ([3fcd637](https://github.com/gorkking/treehouse-manage-worktrees/commit/3fcd63771a6368fa357a9a4079a9b6e242202dcb))
* detect squash-merged worktrees ([#88](https://github.com/gorkking/treehouse-manage-worktrees/issues/88)) ([a651776](https://github.com/gorkking/treehouse-manage-worktrees/commit/a651776a47a2911d260c55472ccdfc5f6a3aeaf8))
* **get:** skip reclaiming a pool slot that holds unlanded work ([#104](https://github.com/gorkking/treehouse-manage-worktrees/issues/104)) ([04d8725](https://github.com/gorkking/treehouse-manage-worktrees/commit/04d87252f918dc3942318817b74413bf55f5b3eb))
* ignore in-project pool via .git/info/exclude ([fdb3f99](https://github.com/gorkking/treehouse-manage-worktrees/commit/fdb3f99ba1c7c6d24db7efbcbb569a61f6535489))
* install under ~/.local/bin when in PATH ([08bb5b6](https://github.com/gorkking/treehouse-manage-worktrees/commit/08bb5b6ec2fa91d2f9e426164cd3313d90812918))
* **pool:** make state persistence atomic and recoverable ([#55](https://github.com/gorkking/treehouse-manage-worktrees/issues/55)) ([c76015d](https://github.com/gorkking/treehouse-manage-worktrees/commit/c76015d914e8ae7068c024c68c58860e10e8ee52))
* **pool:** prune stale worktree registrations before adding in get ([844acc4](https://github.com/gorkking/treehouse-manage-worktrees/commit/844acc4d1d7d8078f1110295689d94853a921dd7)), closes [#31](https://github.com/gorkking/treehouse-manage-worktrees/issues/31)
* **process:** safely clean up lingering worktree processes ([#17](https://github.com/gorkking/treehouse-manage-worktrees/issues/17)) ([c1e443d](https://github.com/gorkking/treehouse-manage-worktrees/commit/c1e443de639d3bf5a867e71f218153c4816c78ef))
* **process:** wait for SIGKILLed processes to be reaped before return runs git ([#102](https://github.com/gorkking/treehouse-manage-worktrees/issues/102)) ([664adf8](https://github.com/gorkking/treehouse-manage-worktrees/commit/664adf81e4a427080449aa8e4b76b53cc54f8a24))
* recheck app update when cached version is stale ([21d93e2](https://github.com/gorkking/treehouse-manage-worktrees/commit/21d93e2e36eb3948623e21a6e92c520bae476da9))
* **return:** refuse to reset a worktree that still has live writers ([#103](https://github.com/gorkking/treehouse-manage-worktrees/issues/103)) ([978da87](https://github.com/gorkking/treehouse-manage-worktrees/commit/978da8750da4f6faebbef90ccdb23aaac6211118))
* shorter version display ([9c51b35](https://github.com/gorkking/treehouse-manage-worktrees/commit/9c51b35fdb34cc1230d14c6695cd32f04345cf9b))
* update repository URLs ([b9d1fda](https://github.com/gorkking/treehouse-manage-worktrees/commit/b9d1fda8f919411002e8d5119e35693e7a97fbbe))
* update vendor hash handling in workflow ([fe692a5](https://github.com/gorkking/treehouse-manage-worktrees/commit/fe692a5fdce020a003581abece3d7eacf88dfb03))
* use remote URL for pool hash for local repos ([7b13a4d](https://github.com/gorkking/treehouse-manage-worktrees/commit/7b13a4dd52dbef7270cd1535575e1a0610d8d296))
* windows test failure ([4e24e5f](https://github.com/gorkking/treehouse-manage-worktrees/commit/4e24e5ff502e502f657bb417ea74a44012a28eb8))
